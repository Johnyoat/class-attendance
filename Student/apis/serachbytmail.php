...
<div class="input-group">
                ...
                <select class="form-control" name="attz" id="attz" onchange="showUser(this.value)">'>
<option></option>
...
<option style="color:red">Absent</option>
                ...
                <div class="input-group-btn">
                  <button id="<?php echo $maid; ?>" name="<?php echo $manam; ?>" onclick="attacktime(this.id,this.name,attzs.value);" type="button" class="btn btn-danger">Record</button>
                </div>
              </div>
