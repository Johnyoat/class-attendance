...
<!--<p>-->
<!--<center><B> <font color="red">--><?php //echo $catz; ?><!--</font> </B></center></p>-->
<!--<p>-->
<!--<center><B> <font color="red">--><?php //echo $studlev; ?><!--</font> </B></center></p>-->
<!--<p>-->
<!--<center><B> <font color="red">--><?php //echo $studper; ?><!--</font> </B></center></p>-->
<!--<p>-->
<!--<center><B> <font color="red">--><?php //echo $coursez; ?><!--</font> </B></center></p>-->
<!---->
...
<!---->
<!--    <p>-->
<!--    <center><B> SET DATE </B></center>-->
<!--    </p>-->
<!--    <center><input id="attdats" name="attdats" data-provide="datepicker"></center>-->
<!--    <br>-->
<!--    <center>-->
<!--        <button id="--><?php //echo $maid; ?><!--" name="--><?php //echo $manam; ?><!--"-->
<!--                onclick="attacktime(this.id,this.name,attzs.value);" type="button" class="btn btn-danger">Record-->
<!--        </button>-->
<!--    </center>-->
<!---->
<!--    <div class="col-sm-4">-->
...
if ($results->num_rows > 0) {
    ...
    $data = rawurlencode('{ "catz":"'.$catz.'","coursez":"'.$coursez.'","levelz":"'.$studlev.'","periodz":"'.$studper.'"}');
    $url = 'https://api.qrserver.com/v1/create-qr-code/?&data='.$data;
    echo '
<div class="row center-block">
    <h1>Scan Class Code...</h1>
    <img src="'.$url.'" id="qr-code-image">
</div>
    ';
    return;
...
if ($resulte->num_rows > 0) {
    while ($rowe = $resulte->fetch_assoc()) {
        ...
        <div class="row" style="overflow:auto;">
            <div class="col-sm-4">
                <label id="<?php echo $rowe["studz"]; ?>"
                       name="<?php echo $rowe["studz"]; ?>"><?php echo $rowe["studz"]; ?></label>

            </div>

            <div class="col-sm-4">
                <label id="<?php echo $rowe["studidz"]; ?>"
                       name="<?php echo $rowe["studidz"]; ?>"><?php echo $rowe["studidz"]; ?></label>
...
?>
<!--<p class="d-none" id="text-code"></p>-->
<!--<div class="row center-block">-->
<!--    <p>Scan Code...</p>-->
<!--    <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=Example" id="qr-code-image">-->
<!--</div>-->
<!--<script>-->
