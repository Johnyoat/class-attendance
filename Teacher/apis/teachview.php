...
<div class="box box-primary">
  ...
  <div class="form-group has-feedback">
   <label><h3>Load Students</h3></label>   
...
<option>Second Semester.</option>
       ...
       <div class="form-group has-feedback">
  <p> Date </p>
     <input id="attdats" name="attdats" data-provide="datepicker">
      </div>


   
              <a onclick="teachviewadmin();" href="#" class="btn btn-primary btn-block"><b>LOAD</b></a>
            </div>
          </div>
